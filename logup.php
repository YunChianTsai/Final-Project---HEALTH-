        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="width:600px;">
                ...
                <div class="modal-body" >
                    <!-- 登入表單 -->
                    <form action="logup.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer" style="border:none;margin:0px 5px -15px 5px">
                            <!-- 送出按鈕 -->
                            <input type="button" value="Sent!" class="btn btn-info" style="width:100px;border:none;background-color:#000;color:#fff;margin-right:-12px;"></input>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="table" style="background:#fff">
    <form action="logupconfirm.php" method="post" enctype="multipart/form-data">
    <table width="600px" height="380px" style="border-width:1px;border-style:solid;border-color:#a9a9a9;">
        <tr height="60px">
            <td align="center"><font size="3" color="#000000"><b>註冊會員</b></font></td>
            <td align="center" style="background-color:#f5f5f5"><a href='login.php' style="text-decoration:none"><font size="3" color="#000000"><b>會員登入</b></font></a></td>
        </tr>
        <tr>
            <td colspan="2" align="center" height="60px">
            <input type="text" name="uname" autocomplete="off" placeholder="    暱稱(不得超過12個字元)" style="width: 85%;height: 70%"; required/>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center" height="60px">
            <input type="email" name="uaccount" autocomplete="off" placeholder="    電子信箱" style="width: 85%;height: 70%"; required/>
            </td>
        </tr>
        <tr height="60px">
        ...
        <tr height="60px">
            <td colspan="2" align="center">
            <input type="password" name="upwd" autocomplete="off" placeholder="    請再輸入一次密碼" style="width:85%;height: 70%;" required/>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center">
            <input type="submit" name="" value="立即加入" style="width:85%;height: 60%;background-color:#1e90ff;border:none;color:#ffffff;"/></td>
        </tr>    
    </table>
    </form>
</div>

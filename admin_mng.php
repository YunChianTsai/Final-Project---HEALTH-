...
<div class="personal" style="width: 850px;margin-top: -180px;margin-left: -425px;">
    ...
    <?php
        ...
        echo "<tr>";
        echo "<td align='center' colspan='7'><font size=6 style='border-radius:20px;color: #f0fff0;background-color:#8b3a62;'><b>系統管理員列表</b></font></td>";
        echo "</tr>";
        echo "<tr>";

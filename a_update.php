...
<div class="personal" style="width: 720px;margin-top: -125px;margin-left: -360px;background-color:#fff;border-radius:20px;">
    <form action="a_uconfirm.php" method="post" enctype="multipart/form-data" style="width:100%;height:100%;">
        <table style="width:100%;height:100%;">
            <tr height="60px">
                <td colspan="4" align="center" style="color:#8b3a62;"><font size="5"><b>編輯管理員資料</b></font></td>
            </tr>
            <tr height="70px">
            ...
            <tr height="50px">
                <td align="center" height="60px" width="120px" style="border:solid;border-color:#fff;border-radius:20px;background-color:#cd6090;color:#f5f5f5;"><b>姓名</b></td>
                <td align="center" height="60px" width="240px" style="border:solid;border-color:#fff;border-radius:20px;background-color:#f5f5f5;">
                    <input type="text" name="uname" autocomplete="off" value="<?php echo $uname;?>" style="width: 50%;height: 70%";/>
                </td>
                <td align="center" height="60px" width="120px" style="border:solid;border-color:#fff;border-radius:20px;background-color:#cd6090;color:#f5f5f5;"><b>角色</b></td>
                <td align="center" height="60px" width="240px" style="border:solid;border-color:#fff;border-radius:20px;background-color:#f5f5f5;">

...
<header class="main-header">
    <div class="container" style="background-color:#f5fffa;border-bottom-style:solid;border-color:#e8e8e8">
        ...
        <ul class="nav">
            ...
            <li><a href='#'><b>BODY計算機</b><span class="fa fa-angle-down"></span></a>
                <nav class="second-nav" style="background:#fff">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="width:600px;">
                ...
                <div class="modal-body" >
                    <!-- 登入表單 -->
                    <form action="BMI_login.php" method="post" enctype="multipart/form-data">
...
<font size=6 style="width:200px;text-align:center;color:#f0fff0;background-color:#003e3e;border-radius:20px;" class="title"><b>BMI計算器</b></font>
<div class="bmi">
    <div class="bmi_intro" style="width:800px;height:120px;background-color:#f0fff0;padding:25px;color:#003e3e;">
    ...
    <div class="bmi_table" style="background:#fff;border-radius: 20px;">

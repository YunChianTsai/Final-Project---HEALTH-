        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="width:600px;">
                ...
                <div class="modal-body" >
                    <!-- 登入表單 -->
                    <form action="BMRTDEE_login.php" method="post" enctype="multipart/form-data">
...
<font size=6 style="width:300px;text-align:center;border-radius:20px;color:#f0fff0;background:#003e3e;" class="title"><b>BMR/TDEE計算器</b></font>
<div class="bmi">

        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="width:600px;">
                ...
                <div class="modal-body" >
                    <!-- 登入表單 -->
                    <form action="choose_s.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group2" style="border:none;margin:12px 5px 0px 5px">
                            <textarea type="text" name="text" maxlength="250" autocomplete="off" style="resize:none;height:100px;" class="text form-control" placeholder="請輸入您的訊息(最多可輸入250位文字)" required></textarea>
                        </div>
...
<div class="personal" style="background-color:#fff;border-radius: 20px;width: 800px;margin-top: -150px;margin-left: -400px;">
    ...
    <?php
        ...
        echo "<tr>";
        echo "<td height='50px' align='center'><h5><b>共".$data_nums."筆</td><td align='center'><h5><b>分類</td><td align='center'><h5><b>運動名稱</td><td align='center'><h5><b>消耗熱量(小時)</td></h5>";
        echo "</tr>";
            while($row=mysqli_fetch_assoc($result)){
                $sname=$row["sname"];
                echo "<tr>";
                echo "<td align='center'><input name='sport[]' type='checkbox' value='$sname'></td><td align='center'>".$row["stype"]."</td><td align='center'>".$row["sname"]."</td><td align='center'>".$row["sunitc"]*$weight." kcal"."</td>";
                echo "</tr>";
            }
        echo "<tr>";
        echo "<td height='50px' colspan='4' align='center'><input type='submit' value='加入' style='width:28%;background-color:#000;border:none;color:#fff;'/></td>";
        echo "</tr>";
        echo "</table>";
    ?>
    </form>

<!-- <?php
    ...
    <header class="main-header">
        <div class="container" style="background-color:#fff0f5;border-bottom-style:solid;border-color:#e8e8e8">
            ...
            <nav class="icon-nav">
                <a href='msg_mng'><span class="fa fa-commenting" style="font-size: 1.6em"></sapn></a>
    ...
    <div class="personal" style="width: 1000px;margin-top: -180px;margin-left: -500px;">
        <div height="100%" width="100%" style="background-color:#fff;">
        <?php
            require("DBconnect.php");
            $SQL="SELECT * FROM replymsg";
            $result=mysqli_query($link,$SQL);
            ...
            echo "<tr>";
            echo "<td height='60px' colspan='2' align='center' style='background:#f5f5f5'><a href='msg_mng.php' style='text-decoration:none;color:#000000'><h5>未回覆訊息</td><td colspan='3' align='center'><h5><b>已回覆訊息</td><h5>";
            echo "</tr>";
            echo "<tr>";
            echo "<td height='60px' align='center'><h5><b>編號</td><td align='center'><h5><b>帳號</td><td wigth='250px' align='center'><h5><b>訊息</td><td wigth='250px' align='center'><h5><b>回覆</td><td wigth='250px' align='center'><h5><b>".'(共 '.$data_nums." 筆)</td></h5>";
            echo "</tr>";
                            while($row=mysqli_fetch_assoc($result)){
                    echo "<tr>";
                    echo "<td width='120px' align='center'>"."NO.".$row["rno"]."</td><td width='200px' align='center'>".$row["rmail"]."</td><td style='width:250px;align:center;word-break:break-all;word-wrap:break-word;' >".$row["rtext"]."</td><td style='width:250px;align:center;word-break:break-all;word-wrap:break-word;' >".$row["reply"]."</td><td width='100px' align='center'><a href='rm_dconfirm.php?rno=".$row["rno"]."' style='text-decoration:none;color:#000;'><span class='fa fa-trash' style='font-size: 1.2em'></span></a></td>";
                    echo "</tr>";
                }
            echo "</table>";
        ?>
            <div style="margin-top: 0px;margin-left: 425px;">
            <?php
